      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block  " style="background:url('logo.png');background-position: center;
    background-size: cover;"></div>
              <div class="col-lg-6">
				...
				?>
					...
					<?php if($hres[0]['setting_value']==""){ ?>Craft Quiz <?php }else{ echo $hres[0]['setting_value']; }?> 
	...
	<!--		&nbsp;&nbsp;&nbsp;<a class="small" href="<?php echo site_url('quiz/open_quiz/0');?>"  ><?php echo $this->lang->line('open_quizzes');?></a>
			...
			?>
                 ...
                 <!--   <a class="btn btn-danger btn-user btn-block" href="<?php echo site_url('login/pre_registration');?>"><?php echo $this->lang->line('register_new_account');?></a>
                   -->
				  <p style="margin-top:40px;""><a class="small" href="https://app.icraftsoft.net" style="float:right;">Craft Software</a></p>
