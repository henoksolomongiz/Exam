...
<?php 
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="https://app.icraftsoft.net">
         
        <div class="sidebar-brand-text mx-3"><?php if($hres[0]['setting_value']==""){ ?>Craft Quiz  <?php }else{ echo $hres[0]['setting_value']; }?> </div>
  ...
  <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapseLanding" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          ...
          <a class="collapse-item" href="<?php echo site_url('cms_admin/menu_list');?>">Menu</a>
           
          <a class="collapse-item" href="<?php echo site_url('cms_admin/page_list');?>">Pages/Post</a>
          <a class="collapse-item" href="<?php echo site_url('cms_admin/slider');?>">Slider</a>
           <a class="collapse-item" href="<?php echo site_url('cms_admin/design');?>">Design</a>
         </div>
        </div>
      </li>
