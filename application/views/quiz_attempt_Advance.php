...
<?php echo str_replace('../../../',base_url(),str_replace('../../../../',base_url(),$question['question'])); ?>		 
		...
		<div class="op op_style" onClick="checkrad('answer_value<?php echo $qk.'-'.$i;?>');" > <table><tr><td><input type="radio" name="answer[<?php echo $qk;?>][]"  id="answer_value<?php echo $qk.'-'.$i;?>" value="<?php echo $option['oid'];?>"   <?php if(in_array($option['oid'],$save_ans)){ echo 'checked'; } ?> style="position:relative;" > </td><td> <?php echo str_replace('../../../',base_url(),str_replace('../../../../',base_url(),$option['q_option']));?></td></tr></table> </div>
...
// multiple_choice_multiple_answer	
		...
		<table><tr><td> <input type="checkbox" name="answer[<?php echo $qk;?>][]" id="answer_value<?php echo $qk.'-'.$i;?>"   value="<?php echo $option['oid'];?>"  <?php if(in_array($option['oid'],$save_ans)){ echo 'checked'; } ?> style="position:relative;" > </td><td> <?php echo str_replace('../../../',base_url(),str_replace('../../../../',base_url(),$option['q_option']));?> </td></tr></table> </div>
...
<div  id="warning_div" style="padding:10px; position:fixed;z-index:1400;display:none;width:100%;border-radius:5px;height:200px; border:1px solid #dddddd;left:4px;top:70px;background:#ffffff;">
